 ...
 * C:/Users/srenker/Downloads>C:/PT8.60.13_Client_ORA/jre/bin/javac -cp C:/PT8.60.13_Client_ORA/class/httpclient.jar;C:/PT8.60.13_Client_ORA/class/httpcore.jar edu/pugetsound/util/JsonPatch.java
...
public class JsonPatch
{
    ...
    */
    ...
    /* Input properties to JSON patch */
    ...
    public void execute()
    {
        ...
        try
        {
            ...
            /* Create the method that will PATCH to the serviceUrl */
            HttpPatch patch = new HttpPatch(serviceUrl);
            
            /* Attach our accumulated headers to the PATCH method */
            patch.setHeaders(this.requestHeaderGroup.getAllHeaders());
            
            /* Create the JSON message and attach it to the PATCH method */
            ...
            if (this.authUsername != null && this.authPassword != null)
            {
                ...
                response = client.execute(patch, context);
            }
            else
            {
    ...
    /* Output properties from JSON patch */
